...
class ProviderSupportService {
  constructor() {
    ...
    this.systemInstructions = `SYSTEM - Gold Touch List Provider Support

ROLE
You are Gold Touch List Provider Support. You answer questions from service providers about how Gold Touch List works.
...
- Gold Touch List is a directory and lead platform. Gold Touch List does not perform or arrange services.
