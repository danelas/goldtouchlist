-- Gold Touch List Lead System Database Setup
...
-- Insert your existing providers (if they don't exist)
...
SELECT provider_id, name, phone, sms_opted_out FROM providers ORDER BY provider_id;
